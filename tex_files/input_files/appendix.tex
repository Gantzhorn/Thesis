...
\section{Development of Simulation Methods}
...
\begin{align}
    ...
    &\left(\left(A\left(X_{t_k} - m\right)\right)\cdot \left(A\left(X_{t_k} - m\right)^2 + \lambda_{t_k}\right) + \frac{A}{2}\sigma^2 X_{t_k}\right)\Delta t_k^2 -\nonumber\\
...
\begin{align}
    ...
    &-2A(X_{t_k} - m)\sigma X_{t_k} \Delta \zeta_k + \frac{1}{2}\left(2A\left(X_{t_k} - m\right)\left(A\left(X_{t_k} - m\right)^2 + \lambda_{t_k}\right) - A\sigma^2X_{t_k}\right)(\Delta t_k)^2 \nonumber \\
    &- \left(A\left(X_{t_k} - m\right)^2 + \lambda_{t_k}\right)\left(\Delta W_{k}\Delta t_k - \Delta \zeta_k\right).
\end{align}
\section{Formulation of Estimators}
