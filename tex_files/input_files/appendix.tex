...
\end{align}
As in the stationary part (\ref{eq:GBM_dynamic_SDE}) has lamperti transform $Y_t:= g(X_t, t) = \log(X_t)$. Therefore, we get from Ito's formula
\begin{align}
