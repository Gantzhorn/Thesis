...
\begin{align}
    f(y) := - \frac{1}{y}\left(\alpha_0 \frac{y^2}{2} - 2 \alpha_0 \mu_0 + \frac{\sigma^2}{2}\right) = 0
\end{align}
in terms of $y$. This is $y^* = \pm \sqrt{\frac{\alpha_0\mu_0 - \sigma^2}{\alpha_0}}$. In our case, however, $Y_t$ is non-negative by definition; thus we only want the positive solution. Therefore, we let the Ornstein-Uhlenbeck part be the linearization around the positive fixed point
\begin{align}
...
\begin{align}
    ...
    \mathrm{d}Y_t^{[2]} &= \left(\alpha_0 + \frac{\sigma^2}{2}\right) \left(Y_t^{[2]} - \cosh^{-1}\left(\frac{2\alpha_0\left(2\mu + 1\right)}{2\alpha_0 + \sigma^2}\right) - \coth\left(Y_t^{[2]}\right) \right.\nonumber\\
    &+ \left. \frac{2\alpha_0\left(2\mu + 1\right)}{\left(2\alpha_0 + \sigma^2\right)\sinh(Y_t^{[2]})}\right)\mathrm{d}t.
\end{align}
