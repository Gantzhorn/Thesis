...
Let $Y_t:= 2\sqrt{X_t}$ and use Ito's formula on (\ref{eq:dynamicsquarerootSDE}), then
\begin{align}
...
\end{align}
Where $(\dagger_1)$ uses the identity from earlier in the denominator and the following half-angle identity twice
\begin{align*}
