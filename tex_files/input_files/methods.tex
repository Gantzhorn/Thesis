...
A lot more can be said about the qualitative behaviour of these processes. In any case, it is evident that the the models are parametric. For us to do any inference on them, we need to be able to parameter estimation in stochastic differential equation. And this is something we have yet to introduce. 
