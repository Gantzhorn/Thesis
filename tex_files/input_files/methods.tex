...
The Strang based estimator is a method based on splitting schemes. Other similar methods exists. Though, the one-step predictions of transition densities given by the Strang splitting scheme is proven to be superior; compare \cite[Proposition 3.4 and 3.6]{SplittingSchemes}. We first consider the Strang splitting schemes on a general one-dimensional SDE with additive noise. Later we comment on the possible ways to use this method even for models with multiplicative noise.\\
